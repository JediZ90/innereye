package org.innereye.ms.restful.support;
...
import org.innereye.ms.restful.annotation.Ctrl;
import org.innereye.ms.restful.annotation.RES;
import org.innereye.ms.restful.annotation.Serv;
import org.innereye.ms.restful.common.ScanPackage;
            ...
            for (Class<?> clazz : clazzs) {
                ...
                if (ctrl != null && serv != null) {
                    throw new RuntimeException("The '" + clazz.getName()
                            + "' of ctrl and serv can not be simultaneously as one");
                }
                else {
                    // $NON-NLS-扫描服务层$
                    if (serv != null) {
                        try {
                            ...
                            throw new RuntimeException("The class '" + clazz
                                    + "' must contain a default constructor that can be accessed by an external.");
                        }
                    }
                    else {
                        // $NON-NLS-扫描控制器$
