...
public class RouteResult<T> {
     ...
     */
    public RouteResult(String uri, String decodedPath, Map<String, String> pathParams,
            Map<String, List<String>> queryParams, T target){
    ...
    /**
     * Extracts the param in {@code pathParams} first, then falls back to the
     * first matching
    ...
    /**
     * Extracts all params in {@code pathParams} and {@code queryParams}
     * matching the name.
     *
